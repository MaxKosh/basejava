...
public class ResumeTestData {
    ...
    static {
        resume_1 = new Resume("Name_4 Surname_4");
        resume_2 = new Resume("Name_3 Surname_3");
        resume_3 = new Resume("Name_2 Surname_2");
        resume_4 = new Resume("Name_2 Surname_2");

        resume_1.addContact(ContactType.E_MAIL, "name1@yandex.ru");
        resume_1.addContact(ContactType.PHONE_NUMBER, "+7(999)999-9999");
        resume_1.addContact(ContactType.SKYPE, "name1.surname1");
